...
var rootCmd = &cobra.Command{
	Use:   "devopsctl",
	Short: "Streamline development operations",
	Long:  `Streamline development operations`,
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".devopsctl" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigType("yaml")
		viper.SetConfigName(".devopsctl")
	}
